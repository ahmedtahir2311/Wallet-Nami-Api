  ...
  return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            ...
            case 1:
              return [
                2 /*return*/,
                _b.apply(_a, [_d.apply(_c, [_e.sent(), "hex"])]).to_bech32(),
              ];
          }
        });
      });
    ...
    function getAddressHex() {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, Nami.getChangeAddress()];
            case 1:
              return [2 /*return*/, _a.sent()];
          }
        });
          ...
          switch (_h.label) {
            ...
            case 1:
              return [
                2 /*return*/,
                (_a = _c.apply(_b, [
                  _e.apply(_d, [_g.apply(_f, [_h.sent(), "hex"])]),
                ])) === null || _a === void 0
                  ? void 0
                  : _a.to_address().to_bech32(),
              ];
          }
        });
      });
    ...
    function getRewardAddressHex() {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, Nami.getRewardAddress()];
            case 1:
              return [2 /*return*/, _a.sent()];
          }
        });
    ...
    function getNetworkId() {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, Nami.getNetworkId()];
            case 1:
              networkId = _a.sent();
              return [
                2 /*return*/,
    ...
    function getAssets() {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, getUtxos()];
            case 1:
              Utxos = _a.sent();
              AssetsRaw = [];
              Utxos.forEach(function (u) {
                AssetsRaw.push.apply(
                  AssetsRaw,
                  u.amount.filter(function (a) {
              ...
              AssetsMap = {};
              for (
                _i = 0, AssetsRaw_1 = AssetsRaw;
                _i < AssetsRaw_1.length;
                _i++
              ) {
                k = AssetsRaw_1[_i];
              ...
              return [
                2 /*return*/,
                Object.keys(AssetsMap).map(function (k) {
                  return { unit: k, quantity: AssetsMap[k].toString() };
                }),
              ];
          }
        });
    ...
    function send(_a) {
      var address = _a.address,
        _b = _a.amount,
        amount = _b === void 0 ? 0 : _b,
        _c = _a.assets,
        assets = _c === void 0 ? [] : _c,
        _d = _a.metadata,
        metadata = _d === void 0 ? null : _d,
        _e = _a.metadataLabel,
        metadataLabel = _e === void 0 ? "721" : _e;
      return __awaiter(this, void 0, void 0, function () {
        var PaymentAddress,
          protocolParameter,
          utxos,
    ...
    function sendMultiple(_a) {
      var _b = _a.recipients,
        recipients = _b === void 0 ? [] : _b,
        _c = _a.metadata,
        metadata = _c === void 0 ? null : _c,
        _d = _a.metadataLabel,
        metadataLabel = _d === void 0 ? "721" : _d;
      return __awaiter(this, void 0, void 0, function () {
        var PaymentAddress,
          protocolParameter,
          utxos,
          ...
          switch (_e.label) {
            ...
            case 3:
              ...
              for (
                ...
                _i < recipients_1.length;
                _i++
              ) {
                recipient = recipients_1[_i];
                lovelace = Math.floor(
                  (recipient.amount || 0) * 1000000
                ).toString();
    ...
    function delegate(_a) {
      var poolId = _a.poolId,
        _b = _a.metadata,
        metadata = _b === void 0 ? null : _b,
        _c = _a.metadataLabel,
        metadataLabel = _c === void 0 ? "721" : _c;
      return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
              switch (_a.label) {
                case 0:
                  return [
                    4 /*yield*/,
                    _blockfrostRequest("/accounts/" + rewardAddr),
                  ];
                case 1:
                  stake = _a.sent();
        ...
        return __generator(this, function (_l) {
          switch (_l.label) {
            ...
            case 2:
              stakeKeyHash = _e
                .apply(_d, [_g.apply(_f, [_j.apply(_h, [_l.sent(), "hex"])])])
                .payment_cred()
                .to_keyhash()
                .to_bytes();
              _k = getDelegation;
            ...
            case 3:
              return [4 /*yield*/, _k.apply(void 0, [_l.sent()])];
            case 4:
              delegation = _l.sent();
            ...
            case 7:
              ...
              outputs.add(
                S.TransactionOutput.new(
                  ...
                  S.Value.new(S.BigNum.from_str(protocolParameter.keyDeposit))
                )
              );
    ...
    function _txBuilder(_a) {
      var PaymentAddress = _a.PaymentAddress,
        Utxos = _a.Utxos,
        Outputs = _a.Outputs,
        ProtocolParameter = _a.ProtocolParameter,
        _b = _a.Metadata,
        Metadata = _b === void 0 ? null : _b,
        _c = _a.MetadataLabel,
        MetadataLabel = _c === void 0 ? "721" : _c,
        _d = _a.Delegation,
        Delegation = _d === void 0 ? null : _d;
      ...
      var selection = CoinSelection.randomImprove(
        Utxos,
        Outputs,
        20 + totalAssets
      );
      var inputs = selection.input;
      var txBuilder = S.TransactionBuilder.new(
        S.LinearFee.new(
        ...
        certificates.add(
          S.Certificate.new_stake_delegation(
            S.StakeDelegation.new(
              ...
              S.Ed25519KeyHash.from_bytes(Buffer.from(poolKeyHash, "hex"))
            )
          )
        );
        ...
        var makeSplit = function () {
          for (var j = 0; j < changeMultiAssets.len(); j++) {
            ...
            for (var k = 0; k < assetNames.len(); k++) {
              ...
              //check size
              var checkMultiAssets = S.MultiAsset.from_bytes(
                partialMultiAssets_1.to_bytes()
              );
      ...
      var transaction = S.Transaction.new(
        txBuilder.build(),
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                Nami.submitTx(Buffer.from(signedTx.to_bytes()).toString("hex")),
              ];
            case 2:
              txhash = _a.sent();
              return [2 /*return*/, txhash];
    ...
    function _getProtocolParameter() {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, _blockfrostRequest("/blocks/latest")];
            case 1:
              latestBlock = _a.sent();
    ...
    function _blockfrostRequest(endpoint) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, getNetworkId()];
            case 1:
              return [4 /*yield*/, _a.sent().id];
            case 2:
              networkId = _a.sent();
              networkEndpoint =
                networkId == 0
            ...
            case 3:
              ...
              return [
                4 /*yield*/,
                fetch("" + networkEndpoint + endpoint, {
                  headers: {
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            Promise.resolve().then(function () {
              return __importStar(require("buffer"));
            }),
          ];
        case 3:
          ...
          return [
            4 /*yield*/,
            Promise.resolve().then(function () {
              return __importStar(require("node-fetch"));
            }),
          ];
        case 4:
          ...
          return [
            4 /*yield*/,
            Promise.resolve().then(function () {
              return __importStar(require("./coinSelection"));
            }),
          ];
        case 5:
